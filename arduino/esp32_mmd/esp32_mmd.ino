...
void lcd_init(spi_device_handle_t spi)
{
  ...
  while (lcd_init_cmds[cmd].databytes != 0xff) {
    ...
    lcd_data(spi, (uint8_t*)lcd_init_cmds[cmd].data, lcd_init_cmds[cmd].databytes & 0x1F);
...
void setup()
{
...
#else
  devcfg.clock_speed_hz = 40 * 1000 * 1000;     //Clock out at 26 MHz
#endif
  ...
  gpio_set_direction((gpio_num_t)37, GPIO_MODE_INPUT);
  gpio_set_direction((gpio_num_t)38, GPIO_MODE_INPUT);
  gpio_set_direction((gpio_num_t)39, GPIO_MODE_INPUT);
